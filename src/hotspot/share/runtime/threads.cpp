...
void Threads::destroy_vm() {
  ...
  log_info(os)("toxaart Max_Contentions: %d ", ObjectMonitor::Max_Contentions);
  log_info(os)("toxaart Try_Lock_Calls[0]: %ld // exit", ObjectMonitor::Try_Lock_Calls[0]);
  log_info(os)("toxaart Try_Lock_Calls[1]: %ld // try_lock_or_add_to_entry_list", ObjectMonitor::Try_Lock_Calls[1]);
  log_info(os)("toxaart Try_Lock_Calls[2]: %ld // enter_internal", ObjectMonitor::Try_Lock_Calls[2]);
  log_info(os)("toxaart Try_Lock_Calls[3]: %ld // enter_internal", ObjectMonitor::Try_Lock_Calls[3]);
  log_info(os)("toxaart Try_Lock_Calls[4]: %ld // enter_internal", ObjectMonitor::Try_Lock_Calls[4]);
  log_info(os)("toxaart Try_Lock_Calls[5]: %ld // reenter_internal", ObjectMonitor::Try_Lock_Calls[5]);
  log_info(os)("toxaart Try_Lock_Calls[6]: %ld // reenter_internal", ObjectMonitor::Try_Lock_Calls[6]);
  log_info(os)("toxaart Try_Lock_Calls[7]: %ld // vthread_monitor_enter", ObjectMonitor::Try_Lock_Calls[7]);
  log_info(os)("toxaart Try_Lock_Calls[8]: %ld // vthread_monitor_enter", ObjectMonitor::Try_Lock_Calls[8]);
  log_info(os)("toxaart Try_Lock_Calls[9]: %ld // resume_operation", ObjectMonitor::Try_Lock_Calls[9]);
  log_info(os)("toxaart Try_Lock_Calls[10]: %ld // resume_operation", ObjectMonitor::Try_Lock_Calls[10]);
  log_info(os)("toxaart Try_Lock_Calls[11]: %ld // try_spin", ObjectMonitor::Try_Lock_Calls[11]);
  log_info(os)("toxaart Try_Lock_Calls[12]: %ld // try_enter", ObjectMonitor::Try_Lock_Calls[12]);
  log_info(os)("toxaart Try_Lock_Calls[13]: %ld // short_fixed_spin", ObjectMonitor::Try_Lock_Calls[13]);
  ...
  log_info(os)("toxaart N_Object_Locker_Calls: %ld ", ObjectMonitor::N_Object_Locker_Calls);
  ...
  log_info(os)("toxaart N_Quick_Enter_Calls_Success: %ld ", ObjectMonitor::N_Quick_Enter_Calls_Success);
  log_info(os)("toxaart N_BasicLock_OM_Cache_Calls: %ld ", ObjectMonitor::N_BasicLock_OM_Cache_Calls);
  log_info(os)("toxaart N_BasicLock_OM_Cache_Calls_Success: %ld ", ObjectMonitor::N_BasicLock_OM_Cache_Calls_Success);
  ...
  log_info(os)("toxaart global_om_access_ge_1e6: %ld // ", ObjectMonitor::global_om_access_ge_1e6);
